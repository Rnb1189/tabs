...
export function setTransform(style, v, isRtl) {
  style.transform = v;
...
// }
//NEw:
export function getMarginStyle(index, tabBarPosition, isRtl) {
...
//NEw:
export function getRight(tabNode, wrapperNode) {
  return getTypeValue("right", "offsetWidth", "left", tabNode, wrapperNode);
}
